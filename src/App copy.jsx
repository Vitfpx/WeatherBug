...
export default function App() {
  ...
  return (
    <main className="font-sf-pro flex flex-col md:flex-row p-4 gap-4  bg-gray-400 w-screen h-screen overflow-auto">
      <NavSideBar />
      <div className="flex flex-col w-full md:w-auto justify-between flex-1">
